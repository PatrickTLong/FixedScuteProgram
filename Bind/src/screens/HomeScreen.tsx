        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: s(8) }}>
          ...
          <HeaderIconButton onPress={openNotificationSettings}>
            {notificationsEnabled ? (
              <Svg width={s(iconSize.headerNav)} height={s(iconSize.headerNav)} viewBox="0 0 256 256" fill="#FFFFFF">
              ...
              <Svg width={s(iconSize.headerNav)} height={s(iconSize.headerNav)} viewBox="0 0 256 256" fill={colors.textMuted}>
