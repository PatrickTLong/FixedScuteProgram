...
function LandingScreen() {
  ...
  // Group nudges up so logo+text end centered, text fades in
  const liftY = useRef(new Animated.Value(s(27))).current;
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      <Pressable onPress={handleScreenTap} style={{ flex: 1, justifyContent: 'center', alignItems: 'center', paddingHorizontal: s(32) }}>
        <Animated.View style={{ alignItems: 'center', width: '100%', transform: [{ translateY: liftY }] }}>
          <Animated.View>
            <Svg width={s(160)} height={s(160)} viewBox="0 0 720 720" fill={colors.text}>
